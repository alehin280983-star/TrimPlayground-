...
const openaiModels: ModelConfig[] = [
    ...
    },
    {
        ...
        provider: 'openai',
        batchDiscount: 0.5,
        inputPrice: 0.00175,   // $1.75 / 1M
        outputPrice: 0.014,    // $14.00 / 1M
        cachedInputPrice: 0.000175,
        maxTokens: 400000,
        maxOutputTokens: 128000,
        freeTierAvailable: false,
        description: 'Latest Codex agentic coding model',
        priceUpdatedAt: '2026-03-05',
        speedRating: 3,
        qualityRating: 5,
        modality: 'text',
    ...
    },
    {
        ...
        maxOutputTokens: 128000,
        freeTierAvailable: false,
        description: 'GPT-5.2 Codex variant',
        priceUpdatedAt: '2026-03-05',
        speedRating: 3,
        qualityRating: 5,
        modality: 'text',
    ...
    },
    {
        ...
        maxOutputTokens: 128000,
        freeTierAvailable: false,
        description: 'GPT-5.1 Codex standard variant',
        priceUpdatedAt: '2026-03-05',
        speedRating: 4,
        qualityRating: 5,
        modality: 'text',
    ...
    },
    {
        ...
        freeTierAvailable: false,
        description: 'GPT-5.3 snapshot used in ChatGPT',
        priceUpdatedAt: '2026-03-05',
        speedRating: 4,
        qualityRating: 5,
        modality: 'text',
    ...
    },
    {
        ...
        freeTierAvailable: false,
        description: 'Original GPT-4o snapshot from May 2024',
        priceUpdatedAt: '2026-03-05',
        speedRating: 4,
        qualityRating: 4,
        modality: 'text',
    ...
    },
    {
        ...
        provider: 'openai',
        batchDiscount: 0.5,
        inputPrice: 0.0011,    // $1.10 / 1M
        outputPrice: 0.0044,   // $4.40 / 1M
    ...
    },
    {
        ...
        provider: 'openai',
        batchDiscount: 0.5,
        inputPrice: 0.004,     // $4.00 / 1M
        outputPrice: 0.016,    // $16.00 / 1M
        cachedInputPrice: 0.0004,
        maxTokens: 32000,
        maxOutputTokens: 4096,
        freeTierAvailable: false,
        description: 'Low latency realtime model v1.5',
        priceUpdatedAt: '2026-03-05',
        speedRating: 5,
        qualityRating: 4,
        modality: 'text',
    ...
    },
    {
        ...
        outputPrice: 0.0024,   // $2.40 / 1M
        cachedInputPrice: 0.0003,
        maxTokens: 128000,
        maxOutputTokens: 4096,
        freeTierAvailable: false,
        description: 'Compact GPT-4o realtime preview',
        priceUpdatedAt: '2026-03-05',
        speedRating: 5,
        qualityRating: 4,
        modality: 'text',
    ...
    },
    {
        ...
        provider: 'openai',
        batchDiscount: 0.5,
        inputPrice: 0.0025,    // $2.50 / 1M
        outputPrice: 0.01,     // $10.00 / 1M
        maxTokens: 128000,
        maxOutputTokens: 4096,
        freeTierAvailable: false,
        description: 'Audio input/output model',
        priceUpdatedAt: '2026-03-05',
        speedRating: 4,
        qualityRating: 4,
        modality: 'audio',
    ...
    },
    {
        ...
        maxOutputTokens: 4096,
        freeTierAvailable: false,
        description: 'Compact audio model',
        priceUpdatedAt: '2026-03-05',
        speedRating: 5,
        qualityRating: 3,
        modality: 'audio',
    ...
    },
    {
        ...
        outputPrice: 0.0006,   // $0.60 / 1M
        maxTokens: 128000,
        maxOutputTokens: 4096,
        freeTierAvailable: false,
        description: 'Compact GPT-4o audio preview',
        priceUpdatedAt: '2026-03-05',
        speedRating: 5,
        qualityRating: 4,
        modality: 'audio',
    ...
    },
    {
        ...
        provider: 'openai',
        batchDiscount: 0.5,
        inputPrice: 0.0015,    // $1.50 / 1M
        outputPrice: 0.006,    // $6.00 / 1M
        cachedInputPrice: 0.000375,
        maxTokens: 200000,
        maxOutputTokens: 100000,
        freeTierAvailable: false,
    ...
    },
    {
        ...
        maxOutputTokens: 16384,
        freeTierAvailable: false,
        description: 'GPT-5 variant optimised for web search',
        priceUpdatedAt: '2026-03-05',
        speedRating: 4,
        qualityRating: 5,
        modality: 'text',
    ...
    },
    {
        ...
        maxOutputTokens: 16384,
        freeTierAvailable: false,
        description: 'GPT-4o with search capability',
        priceUpdatedAt: '2026-03-05',
        speedRating: 4,
        qualityRating: 5,
        modality: 'text',
    ...
    },
    {
        ...
        maxOutputTokens: 16384,
        freeTierAvailable: false,
        description: 'Compact GPT-4o with search capability',
        priceUpdatedAt: '2026-03-05',
        speedRating: 5,
        qualityRating: 4,
        modality: 'text',
    ...
    },
    {
        ...
        outputPrice: 0.012,    // $12.00 / 1M
        maxTokens: 128000,
        maxOutputTokens: 16384,
        freeTierAvailable: false,
        description: 'Model for computer use / GUI automation tasks',
        priceUpdatedAt: '2026-03-05',
        speedRating: 3,
        qualityRating: 5,
        modality: 'text',
...
// Anthropic Models (Official API - Updated 2026-03-05)
...
const anthropicModels: ModelConfig[] = [
    // Claude 4.x
    {
        ...
        cachedInputPrice: 0.0005, // $0.50 / 1M
        maxTokens: 1000000,
        maxOutputTokens: 128000,
        freeTierAvailable: false,
    ...
    },
    {
        ...
        provider: 'anthropic',
        batchDiscount: 0.5,
        inputPrice: 0.015,       // $15.00 / 1M
        outputPrice: 0.075,      // $75.00 / 1M
        cachedInputPrice: 0.0015, // $1.50 / 1M
        maxTokens: 200000,
    ...
    },
    {
        ...
        inputPrice: 0.003,       // $3.00 / 1M
        outputPrice: 0.015,      // $15.00 / 1M
        cachedInputPrice: 0.0003, // $0.30 / 1M
        maxTokens: 200000,
        maxOutputTokens: 64000,
        freeTierAvailable: false,
        description: 'Latest Sonnet model balancing intelligence and speed',
        priceUpdatedAt: '2026-03-05',
        speedRating: 4,
        qualityRating: 5,
    },
    ...
    },
    {
        ...
        cachedInputPrice: 0.0001, // $0.10 / 1M
        maxTokens: 200000,
        maxOutputTokens: 64000,
        freeTierAvailable: true,
    ...
    // Claude 3.x Legacy
    {
        ...
        maxOutputTokens: 64000,
        freeTierAvailable: false,
        description: 'Deprecated Sonnet model',
        priceUpdatedAt: '2026-03-05',
        speedRating: 4,
        qualityRating: 4,
    },
    {
        ...
        provider: 'anthropic',
        batchDiscount: 0.5,
        inputPrice: 0.0008,      // $0.80 / 1M
        outputPrice: 0.004,      // $4.00 / 1M
        cachedInputPrice: 0.00008, // $0.08 / 1M
        maxTokens: 200000,
        maxOutputTokens: 8096,
        freeTierAvailable: false,
        description: 'Fast and compact legacy Haiku model',
        priceUpdatedAt: '2026-03-05',
        speedRating: 5,
        qualityRating: 3,
    },
    {
        ...
        maxOutputTokens: 4096,
        freeTierAvailable: false,
        description: 'Deprecated flagship model from Claude 3 generation',
        priceUpdatedAt: '2026-03-05',
        speedRating: 2,
        qualityRating: 4,
    },
    {
        ...
        cachedInputPrice: 0.00003, // $0.03 / 1M
        maxTokens: 200000,
        maxOutputTokens: 4096,
        freeTierAvailable: true,
...
const deepseekModels: ModelConfig[] = [
    {
        ...
        provider: 'deepseek',
        inputPrice: 0.00028,      // $0.28 / 1M (cache miss)
        outputPrice: 0.00042,     // $0.42 / 1M
        cachedInputPrice: 0.000028, // $0.028 / 1M (cache hit)
        maxTokens: 128000,
        maxOutputTokens: 8192,
        freeTierAvailable: true,
...
// Mistral Models (From https://mistral.ai/pricing#api - Updated 2026-03-05)
const mistralModels: ModelConfig[] = [
    {
        ...
        maxOutputTokens: 32000,
        freeTierAvailable: false,
        description: 'Open-weight flagship multimodal and multilingual model',
        priceUpdatedAt: '2026-03-05',
        speedRating: 3,
        qualityRating: 5,
    },
    {
        ...
        maxOutputTokens: 32000,
        freeTierAvailable: false,
        description: 'State-of-the-art performance, simplified enterprise deployments',
        priceUpdatedAt: '2026-03-05',
        speedRating: 4,
        qualityRating: 5,
    },
    {
        ...
        maxOutputTokens: 32000,
        freeTierAvailable: true,
        description: 'SOTA multimodal multilingual lightweight model',
        priceUpdatedAt: '2026-03-05',
        speedRating: 5,
        qualityRating: 4,
    },
    {
        ...
        maxOutputTokens: 32000,
        freeTierAvailable: false,
        description: 'Fine-tuned small model for creative writing, roleplay, and chat',
        priceUpdatedAt: '2026-03-05',
        speedRating: 5,
        qualityRating: 4,
    },
    {
        ...
        maxOutputTokens: 32000,
        freeTierAvailable: true,
        description: 'Best-in-class frontier AI to the edge (14B)',
        priceUpdatedAt: '2026-03-05',
        speedRating: 4,
        qualityRating: 4,
    },
    {
        ...
        maxOutputTokens: 32000,
        freeTierAvailable: true,
        description: 'Best-in-class frontier AI to the edge (8B)',
        priceUpdatedAt: '2026-03-05',
        speedRating: 5,
        qualityRating: 4,
    },
    {
        ...
        maxOutputTokens: 32000,
        freeTierAvailable: true,
        description: 'Best-in-class frontier AI to the edge (3B)',
        priceUpdatedAt: '2026-03-05',
        speedRating: 5,
        qualityRating: 3,
    },
    ...
    },
    {
        ...
        maxOutputTokens: 0,
        freeTierAvailable: false,
        description: 'Document extraction and understanding ($2 / 1000 pages)',
        priceUpdatedAt: '2026-03-05',
        speedRating: 3,
        qualityRating: 5,
    },
    {
        ...
        name: 'Voxtral Mini',
        provider: 'mistral',
        inputPrice: 0.00004,  // $0.04 / 1M text tokens
        outputPrice: 0.00004, // $0.04 / 1M
        maxTokens: 128000,
        maxOutputTokens: 8192,
        freeTierAvailable: false,
        description: 'Low-latency speech recognition, $0.001/min audio',
        priceUpdatedAt: '2026-03-05',
        speedRating: 5,
        qualityRating: 4,
        modality: 'audio',
    },
    {
        ...
        name: 'Voxtral Small',
        provider: 'mistral',
        inputPrice: 0.0001,  // $0.1 / 1M text tokens
        outputPrice: 0.0003, // $0.3 / 1M
        maxTokens: 128000,
        maxOutputTokens: 8192,
        freeTierAvailable: false,
        description: 'Speech and audio understanding, $0.004/min audio',
        priceUpdatedAt: '2026-03-05',
        speedRating: 4,
        qualityRating: 4,
        modality: 'audio',
    },
    {
        ...
        maxOutputTokens: 0,
        freeTierAvailable: false,
        description: 'State-of-the-art embedding model for code',
        priceUpdatedAt: '2026-03-05',
        speedRating: 5,
        qualityRating: 5,
        modality: 'embedding',
    },
    {
        ...
        maxOutputTokens: 0,
        freeTierAvailable: false,
        description: 'State-of-the-art model for text representation',
        priceUpdatedAt: '2026-03-05',
        speedRating: 5,
        qualityRating: 4,
        modality: 'embedding',
    },
    {
        ...
        maxOutputTokens: 0,
        freeTierAvailable: false,
        description: 'Classifier service for text content moderation',
        priceUpdatedAt: '2026-03-05',
        speedRating: 5,
        qualityRating: 4,
    },
